...
@Component({
  selector: 'app-exo-shop-v3-product3',
  standalone: false,
  templateUrl: './exo-shop-v3-product3.component.html',
  styleUrl: './exo-shop-v3-product3.component.css'
})
export class ExoShopV3Product3Component {
