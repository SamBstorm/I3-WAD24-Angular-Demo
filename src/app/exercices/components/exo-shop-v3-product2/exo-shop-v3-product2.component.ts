...
@Component({
  selector: 'app-exo-shop-v3-product2',
  standalone: false,
  templateUrl: './exo-shop-v3-product2.component.html',
  styleUrl: './exo-shop-v3-product2.component.css'
})
export class ExoShopV3Product2Component {

  public productName : string = 'Téléphone';
